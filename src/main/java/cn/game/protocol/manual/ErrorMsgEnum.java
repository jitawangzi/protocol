...
public enum ErrorMsgEnum {
	...
	//公会相关
	zong_men_not_exist(411, "公会不存在"),
	max_zong_men_num(412, "公会成员数量达到上限"),
	...
	zong_men_player_member_not_exist(420, "公会成员不存在"),
	zong_men_position_member_num_not_enough(421, "公会职位成员数量不足，不可操作"),

...
public enum ErrorMsgEnum {
	...
	//仙会相关
	zong_men_not_exist(411, "仙会不存在"),
	zong_men_exist(413, "仙会已经存在,不可重复加入"),
	zong_men_name_repeat(414, "仙会名称重复"),
	zong_men_apply_exist(415, "该仙会已经申请过，不可重复申请"),
	...
	zong_men_not_allow_join(423, "仙会不让加入"),
	zong_men_name_too_long(424, "仙会名字太长"),
	zong_men_player_not_bargain(425, "还没有砍价就购买了"),
	zong_men_apply_max(426, "仙会申请数量达到上限"),
	zong_men_create_failed(428, "仙会创建失败"),
